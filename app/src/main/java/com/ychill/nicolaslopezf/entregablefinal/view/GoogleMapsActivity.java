...
public class GoogleMapsActivity extends AppCompatActivity implements
    ...
    private void getDeviceLocation() {
        ...
        if (ContextCompat.checkSelfPermission(this.getApplicationContext(),
            ...
            Toast.makeText(this, "falta permiso", Toast.LENGTH_SHORT).show();
        ...
        if (mLocationPermissionGranted) {
            ...
            location.setLatitude(-34.547714);
            location.setLongitude(-58.443791);

            Float metersDistance = mCurrentLocation.distanceTo(location);

            Log.d("meters",metersDistance.toString());
